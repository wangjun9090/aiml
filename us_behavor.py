...
output_df['submitted_application'] = clickstream_df['userActions.targetUrl'].str.contains(
...
clickstream_df = clickstream_df[mask].reset_index(drop=True)
...
# Align clickstream_df with final output_df
clickstream_df = clickstream_df[clickstream_df['internalUserId'].isin(output_df['userid'])].reset_index(drop=True)
