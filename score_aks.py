...
# File definitions (relative to AZUREML_MODEL_DIR or local path)
...
# Feature preparation and scoring functions (unchanged from your original code)
...
async def score(request: ScoreRequest):
    ...
    Args:
        request: JSON payload with 'userid'
