...
model_output_file = '/Workspace/Users/jwang77@optumcloud.com/gpd-persona-ai-model-api/data/s-learning-data/models/rf_model_persona_with_weights_092024_032025_v2.pkl'
weighted_behavioral_output_file = '/Workspace/Users/jwang77@optumcloud.com/gpd-persona-ai-model-api/data/s-learning-data/behavior/032025/weighted_us_dce_pro_behavioral_features_092024_032025_v2.csv'
...
def prepare_training_features(behavioral_df, plan_df):
    ...
    # Oversample high-quality minority personas
    minority_personas = ['dental', 'fitness', 'hearing', 'vision']
    ...
    print(f"Rows after oversampling high-quality minority personas: {len(training_df_oversampled)}")
